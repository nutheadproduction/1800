...
declare global {
  ...
  interface DirectoryPickerOptions {
    ...
    startIn?: FileSystemHandle | FileSystemStartInLocation | undefined
  }

  type FileSystemStartInLocation = 'desktop' | 'documents' | 'downloads' | 'music' | 'pictures' | 'videos';
  ...
  interface FileSystemCopyOptions {
    recursive?: boolean | undefined;
  }
  ...
  interface FileSystemFileHandle extends FileSystemHandle {
    ...
    copy(target: FileSystemFileHandle): Promise<void>;
  ...
  interface FileSystemDirectoryHandle extends FileSystemHandle {
    ...
    copy(target: FileSystemDirectoryHandle, options?: FileSystemCopyOptions): Promise<void>;
